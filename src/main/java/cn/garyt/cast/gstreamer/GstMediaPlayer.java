...
import cn.garyt.cast.gstreamer.player.MediaListener;
import cn.garyt.cast.gstreamer.player.PlayBinMediaPlayer;
import cn.garyt.cast.gstreamer.player.SimpleVideoComponent;
...
public class GstMediaPlayer extends PlayBinMediaPlayer {
    ...
    final private SimpleVideoComponent videoComponent = new SimpleVideoComponent();
    ...
    public SimpleVideoComponent getVideoComponent() {
    ...
    protected class GstMediaListener implements MediaListener {
            ...
            synchronized (GstMediaPlayer.this) {
                currentPositionInfo =
                        new PositionInfo(
                                ...
                                ModelUtil.toTimeString(ClockTime.toSeconds(evt.getPosition())),
                                ModelUtil.toTimeString(ClockTime.toSeconds(evt.getPosition()))
                        );
            }
        }
        ...
        public void durationChanged(final DurationChangedEvent evt) {
            ...
            synchronized (GstMediaPlayer.this) {
                String newValue = ModelUtil.toTimeString(ClockTime.toSeconds(evt.getDuration()));
                currentMediaInfo =
                        new MediaInfo(
                                currentMediaInfo.getCurrentURI(),
                                "",
